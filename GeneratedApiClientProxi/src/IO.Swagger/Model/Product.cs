...
namespace IO.Swagger.Model
{
    ...
    public partial class Product :  IEquatable<Product>, IValidatableObject
    {
        ...
        public Product(int? productID = default(int?), string productName = default(string), int? supplierID = default(int?), int? categoryID = default(int?), string quantityPerUnit = default(string), double? unitPrice = default(double?), int? unitsInStock = default(int?), int? unitsOnOrder = default(int?), int? reorderLevel = default(int?), bool? discontinued = default(bool?), Category category = default(Category), Supplier supplier = default(Supplier))
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.QuantityPerUnit != null && this.QuantityPerUnit.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for QuantityPerUnit, length must be less than 20.", new [] { "QuantityPerUnit" });
            }
