...
namespace IO.Swagger.Model
{
    ...
    public partial class Supplier :  IEquatable<Supplier>, IValidatableObject
    {
        ...
        public Supplier(int? supplierID = default(int?), string companyName = default(string), string contactName = default(string), string contactTitle = default(string), string address = default(string), string city = default(string), string region = default(string), string postalCode = default(string), string country = default(string), string phone = default(string), string fax = default(string), string homePage = default(string), List<Product> products = default(List<Product>))
        {
            ...
            if (companyName == null)
            {
                throw new InvalidDataException("companyName is a required property for Supplier and cannot be null");
            }
            else
            {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ContactName, length must be greater than 0.", new [] { "ContactName" });
            }

            // ContactTitle (string) maxLength
            if(this.ContactTitle != null && this.ContactTitle.Length > 30)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ContactTitle, length must be less than 30.", new [] { "ContactTitle" });
            }

            // ContactTitle (string) minLength
            if(this.ContactTitle != null && this.ContactTitle.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ContactTitle, length must be greater than 0.", new [] { "ContactTitle" });
            }

            // Address (string) maxLength
            if(this.Address != null && this.Address.Length > 60)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Address, length must be less than 60.", new [] { "Address" });
            }
            ...
            if(this.City != null && this.City.Length > 15)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for City, length must be less than 15.", new [] { "City" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Region, length must be less than 15.", new [] { "Region" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Country, length must be less than 15.", new [] { "Country" });
            }
            ...
            if(this.Phone != null && this.Phone.Length > 24)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Phone, length must be less than 24.", new [] { "Phone" });
            }
            ...
            if(this.Fax != null && this.Fax.Length > 24)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Fax, length must be less than 24.", new [] { "Fax" });
            }
